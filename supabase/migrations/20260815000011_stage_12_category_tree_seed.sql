-- Stage 12: Yemanuel Store official category tree.
--
-- Seeds the complete commercial taxonomy:
--   Fashion | Electronics | Cosmetics & Beauty | Home, Living & Appliances
-- Each main category has its full subcategory tree (levels 2 and 3).
--
-- The seed helper app.seed_category() resolves parents by slug and is
-- dropped at the end of this migration — nothing is left behind.
-- Re-running the migration is safe (slug conflict -> do nothing).
