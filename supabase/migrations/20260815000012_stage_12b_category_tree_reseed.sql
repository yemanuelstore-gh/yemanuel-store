-- Stage 12b: idempotent re-seed of the Yemanuel Store category tree.
--
-- Safety net re-run of stage 12. Every insert uses
-- "on conflict (slug) do nothing", so whether the original seed already
-- landed or not, this converges to exactly the same 279 categories.
